...
const ASSESSMENT_QUESTIONS = [
  {
    ...
    options: ['Mental Health', 'Physical Health', 'Life Experiences', 'Career', 'Relationships', 'Hobbies'],
    multiSelect: true,
  },
  {
    id: 'support_type',
    question: 'What type of support are you looking for?',
    options: ['Someone to listen', 'Advice from others', 'Sharing my experiences', 'Learning from others'],
    multiSelect: true,
  },
  {
    id: 'comfort_level',
...
export default function AssessmentScreen() {
  ...
  const completeAssessment = async () => {
    ...
    try {
      ...
      // TODO Figure out how to set onboard to complete 
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <ThemedText style={styles.description}>
        Help us understand your needs better so we can connect you with the right community.
      </ThemedText>
      ...
      <View style={styles.questionContainer}>
        ...
        <ThemedText style={styles.helperText}>
          {currentQuestion.multiSelect ? 'Select all that apply' : 'Select one option'}
        </ThemedText>
      ...
      <View style={styles.buttonsContainer}>
        ...
        <Button
          size="lg"
          action="primary"
          style={[styles.nextButton, currentQuestionIndex === 0 && styles.fullWidthButton]}
          onPress={handleNext}
